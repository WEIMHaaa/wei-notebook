...
echo ""
echo "############################ 磁盘检查 ############################"
df -hiP | sed 's/Mounted on/Mounted/'> /deploy_demo/inode
df -hTP | sed 's/Mounted on/Mounted/'> /deploy_demo/disk
join /deploy_demo/disk /deploy_demo/inode | awk '{print $1,$2,"|",$3,$4,$5,$6,"|",$8,$9,$10,$11,"|",$12}'| column -t
#报表信息
